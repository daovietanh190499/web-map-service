  ...
  var t = {
      808: function() {
          ...
          function e() {
              ...
              var i = {}
                , o = Object.prototype
                , n = o.hasOwnProperty
                , a = Object.defineProperty || function(t, e, i) {
                  t[e] = i.value
              }
              ...
              var _ = Object.getPrototypeOf
                , L = _ && _(_(E([])));
              L && L !== o && n.call(L, s) && (v = L);
              var b = f.prototype = g.prototype = Object.create(v);
              function y(t) {
              ...
              function k(e, i) {
                  function o(a, r, s, l) {
                      ...
                      if ("throw" !== c.type) {
                          var d = c.arg
                            , h = d.value;
                          return h && "object" == t(h) && n.call(h, "__await") ? i.resolve(h.__await).then((function(t) {
                              o("next", t, s, l)
                          }
                          ), (function(t) {
                              o("throw", t, s, l)
                          }
                          )) : i.resolve(h).then((function(t) {
                              d.value = t,
                              s(d)
                          }
                          ), (function(t) {
                              return o("throw", t, s, l)
                          }
                          ))
                      }
                      l(c.arg)
              ...
              p.displayName = d(f, c, "GeneratorFunction"),
              ...
              ,
              y(k.prototype),
              d(k.prototype, l, (function() {
                  return this
              }
              )),
              i.AsyncIterator = k,
              i.async = function(t, e, o, n, a) {
                  void 0 === a && (a = Promise);
                  var r = new k(h(t, e, o, n),a);
                  return i.isGeneratorFunction(e) ? r : r.next().then((function(t) {
          ...
          L.DistortableCollection = L.FeatureGroup.extend({
              ...
              _toggleCollected: function(t, e) {
                  ...
                  )) ? n.push(e) : n.splice(n.indexOf(e), 1)),
              ...
              fetchRemoteJson: function(t) {
                  return o(e().mark((function i() {
                      var o, n, a;
                      return e().wrap((function(e) {
                          for (; ; )
                              ...
                              case 0:
                                  ...
                                  axios.get(t);
                              case 5:
                                  if (!(a = e.sent).data.hasOwnProperty("avg_cm_per_pixel")) {
                                      e.next = 14;
                                      break
                                  }
                                  if (!(a.data.collection.length > 1)) {
                                      e.next = 10;
                                      break
                                  }
                                  return a.data.collection.forEach((function(t) {
                                      n[o] = t,
                                      o++
                                  }
                                  )),
                                  e.abrupt("return", {
                                      avg_cm_per_pixel: a.data.avg_cm_per_pixel,
                                      imgCollectionProps: n
                                  });
                              case 10:
                                  return n[o] = a.data.collection,
                                  e.abrupt("return", {
                                      avg_cm_per_pixel: a.data.avg_cm_per_pixel,
                                      imgCollectionProps: n
                                  });
                              case 14:
                                  ...
                                  return a.data.forEach((function(t) {
                                      n[o] = t,
                                      o++
                                  }
                                  )),
              ...
              recreateImagesFromJsonUrl: function(t) {
                  var i = this;
              ...
              generateExportJson: function() {
                  ...
                  return this.eachLayer((function(i) {
                      if (t || this.isCollected(i)) {
                          var o = i._image.src.split("/")
                            , n = o[o.length - 1]
                            , a = i.getCorners()
                            , r = [{
                              lat: a[0].lat,
                          ...
                          e.images.push({
                              id: i._leaflet_id,
                              src: i._image.src,
                              width: i._image.width,
                              height: i._image.height,
                              tooltipText: i.getTooltipText(),
                              image_file_name: n,
                              nodes: r,
                              cm_per_pixel: L.ImageUtil.getCmPerPixel(i)
                          })
                      }
                  }
                  ), this),
                  e.images = e.images.reverse(),
                  e.avg_cm_per_pixel = this._getAvgCmPerPixel(e.images),
                  e
              }
          }),
          ...
          L.DistortableImageOverlay = L.ImageOverlay.extend({
              ...
              onAdd: function(t) {
                  ...
                  L.DomEvent.on(this.getElement(), "load", (function() {
                      ...
                      e.options.rotation) {
                          var i = e.options.rotation.deg >= 0 ? "deg" : "rad";
              ...
              _initImageDimensions: function() {
                  var t = this._map
                    ...
                    , a = parseInt(o * n)
                    , r = t.project(t.getCenter())
                    , s = L.point(a, n).divideBy(2);
                  this.options.corners ? this._corners = this.options.corners : this._corners = [t.unproject(r.subtract(s)), t.unproject(r.add(L.point(s.x, -s.y))), t.unproject(r.add(L.point(-s.x, s.y))), t.unproject(r.add(s))],
              ...
              _cornerExceedsMapLats: function(t, e, i) {
                  return i.options.crs.Simple != L.CRS.Simple && (0 === t ? (o = i.project(e).y < 2,
              ...
              activateTooltip: function() {
                  this._selected || this.bindTooltip(this.tooltipText, {
                      direction: "top"
                  }).openTooltip()
              },
              ...
              setCornersFromPoints: function(t) {
                  var e = this._map
                    ...
                    , n = 0;
                  for (var a in t) {
                      var r = e.layerPointToLatLng(t[a]);
                      if (this._cornerExceedsMapLats(i, r, e))
                          return this.setBounds(L.latLngBounds(this.getCorners())),
                          void this.fire("update")
                  }
                  for (var s in t)
                      this._corners[n] = e.layerPointToLatLng(t[s]),
                      n += 1;
                  return this.setBounds(L.latLngBounds(this.getCorners())),
                  this.fire("update"),
                  o.toolbar && o.toolbar instanceof L.DistortableImage.PopupBar && o._updateToolbarPos(),
              ...
              getAngle: function() {
                  var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "deg"
                    ...
                    , a = e[5]
                    , r = i * a - o * n
                    , s = L.TrigUtil.calcAngle(i, o, "rad");
                  return r < 0 && (s += s < 0 ? Math.PI : -Math.PI),
                  s < 0 && (s = 2 * Math.PI + s),
                  "deg" === t ? Math.round(L.TrigUtil.radiansToDegrees(s)) : L.Util.formatNum(s, 2)
              },
              setAngle: function(t) {
              ...
              rotateBy: function(t) {
                  var e, i, o, n = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : "deg", a = this._map, r = a.project(this.getCenter()), s = {};
                  for ("deg" === n && (t = L.TrigUtil.degreesToRadians(t)),
                  e = 0; e < 4; e++)
                      i = a.project(this.getCorner(e)).subtract(r),
                      o = L.point(Math.cos(t) * i.x - Math.sin(t) * i.y, Math.sin(t) * i.x + Math.cos(t) * i.y),
                      s[e] = a.unproject(o.add(r));
                  return this.setCorners(s),
                  this
              },
              dragBy: function(t, e) {
                  var i, o, n = this._map, a = {}, r = n.project(t).subtract(n.project(e));
                  for (i = 0; i < 4; i++)
                      o = n.project(this.getCorner(i)).subtract(r),
                      a[i] = n.unproject(o);
                  this.setCorners(a)
              },
              restore: function() {
              ...
              _reset: function() {
                  var t = this._map
                    ...
                    , r = this._getTranslateString(n);
                  e._leaflet_pos = n,
                  e.style[L.DomUtil.TRANSFORM] = [r, a].join(" "),
              ...
              _animateZoom: function(t) {
                  var e = this._map
                    ...
                    , r = L.DomUtil.getMatrixString(n)
                    , s = this._getTranslateString(a);
                  i._leaflet_pos = a,
                  i.style[L.DomUtil.TRANSFORM] = [s, r].join(" ")
              },
              getCorners: function() {
      ...
      782: function() {
          ...
          L.DistortableImage.Keymapper.addInitHook((function() {
              ...
              1 !== L.DistortableImage.Keymapper.prototype._n || L.Browser.mobile || (t.enable(),
              t._injectIconSet())
          }
          )),
          ...
          L.DistortableCollection.Edit = L.Handler.extend({
              ...
              _addCollections: function(t) {
                  ...
                  this._group.eachLayer((function(t) {
                      ...
                      var a = o.getZoom()
                        , r = o.getCenter()
                        , s = L.latLngBounds(t.getCorner(2), t.getCorner(1));
                      s = o._latLngBoundsToNewLayerBounds(s, a, r),
                      i.intersects(s) && n.enabled() && (e.toolbar || e._addToolbar(),
              ...
              _removeGroup: function(t) {
                  ...
                  if (this.hasTool(L.DeleteAction)) {
                      var i = this._group._toRemove()
                        , o = i.length;
                      0 !== o && (L.DomUtil.confirmDeletes(o) && (i.forEach((function(t) {
          ...
          L.DistortableImage.Edit = L.Handler.extend({
              ...
              _enableDragging: function() {
                  ...
                  this.dragging._updatePosition = function() {
                      var t, o, n = e.getCorner(0), a = this._newPos.subtract(i.latLngToLayerPoint(n)), r = {};
                      for (this.fire("predrag"),
                      o = 0; o < 4; o++)
                          t = i.latLngToLayerPoint(e.getCorner(o)),
                          r[o] = i.layerPointToLatLng(t.add(a));
                      e.setCorners(r),
                      e.fire("drag"),
                      this.fire("drag")
                  }
              ...
              _toggleOpacity: function() {
                  ...
                  if (this.hasTool(L.OpacityAction)) {
                      ...
                      var e = this._transparent ? this.options.opacity : 1;
                      L.DomUtil.setOpacity(t, e),
                      t.setAttribute("opacity", e),
                      this._refresh()
                  }
              },
              _setOpacities: function(t) {
                  var e = this._overlay.getElement();
                  this._opacity = t,
                  this.hasTool(L.OpacitiesAction) && (this._opacity < 1 ? this._transparent = !0 : this._transparent = !1,
                  L.DomUtil.setOpacity(e, this._opacity),
                  e.setAttribute("opacity", this._opacity),
                  this._refresh())
              },
              _toggleBorder: function() {
                  ...
                  if (this.hasTool(L.BorderAction)) {
                      ...
                      var e = this._outlined ? this.options.outline : "none";
                      t.style.outline = e,
                      this._refresh()
                  }
              },
              ...
              _removeOverlay: function() {
                  var t = this._overlay
                    , e = this.parentGroup;
                  !this.isMode("lock") && this.hasTool(L.DeleteAction) && L.DomUtil.confirmDelete() && (this._removeToolbar(),
                  ...
                  if (this.hasTool(L.ExportAction)) {
                      ...
                      o.onload = function() {
                          var i = o.height
                            ...
                            , s = e.latLngToLayerPoint(t.getCorner(2))
                            , l = e.latLngToLayerPoint(t.getCorner(3));
                          o.onload = function() {
                              L.DomUtil.remove(o)
                          }
                          ,
                          window && window.hasOwnProperty("warpWebGl") && warpWebGl(o.id, [0, 0, n, 0, n, i, 0, i], [a.x, a.y, r.x, r.y, l.x, l.y, s.x, s.y], !0)
                      }
                      ,
              ...
              _addToolbar: function() {
                  ...
                  if (e && e.anyCollected())
                      ...
                      var r = t.getCenter();
                      r.lat = n,
                      this.toolbar = L.distortableImage.popupBar(r, {
                          actions: this.editActions
                      }).addTo(i, t),
          ...
          L.BorderAction = L.EditAction.extend({
              initialize: function(t, e, i) {
                  ...
                  (i = i || {}).toolbarIcon = {
                      ...
                      html: o,
                      tooltip: n,
                      className: "lock" === r ? "disabled" : ""
                  },
                  L.DistortableImage.action_map.b = "lock" === r ? "" : "_toggleBorder",
      ...
      114: function() {
          L.DeleteAction = L.EditAction.extend({
              initialize: function(t, e, i) {
                  ...
                  L.DistortableImage.action_map.Backspace = "lock" === n._mode ? "" : "_removeOverlay") : (o = e.options.translation.deleteImages,
                  L.DistortableImage.group_action_map.Backspace = "lock" === n._mode ? "" : "_removeGroup"),
                  (i = i || {}).toolbarIcon = {
                      svg: !0,
                      html: "delete_forever",
                      tooltip: o,
          ...
          L.EditAction = L.Toolbar2.Action.extend({
              ...
              _createIcon: function(t, e, i) {
                  var o = this
                    ...
                    , a = n.className
                    , r = this._overlay.editing
                    , s = this.options.toolbarIcon.style;
                  this.toolbar = t,
                  ...
                  s && this._link.setAttribute("style", s),
                  this._link.setAttribute("role", "button"),
                  L.DomUtil.addClass(this._link, this.constructor.baseClass),
                  a && (L.DomUtil.addClass(this._link, a),
                  "disabled" === a && L.DomUtil.addClass(this._icon, a),
                  a === r._mode ? L.DomUtil.addClass(this._link, "selected-mode") : L.DomUtil.removeClass(this._link, "selected-mode")),
      ...
      496: function() {
              ...
              L.EditAction.extend({
                  options: {
                      toolbarIcon: {
                          ...
                          style: "background-color:rgb(" + (100 - t) + "%," + (100 - t) + "%," + (100 - t) + "%);"
                      }
                  },
                  addHooks: function() {
                      this._overlay.editing._setOpacities(t / 100)
                  }
              })
          }
          )),
          L.OpacitiesToolbar2 = L.Toolbar2.extend({
              options: {
                  ...
                  actions: [],
                  style: "translate(-1px, -".concat(30 * (t.length + 1), "px)")
              },
              appendToContainer: function(t) {
                  var e, i, o, n, a = this.constructor.baseClass + "-" + this._calculateDepth() + " " + this.options.className;
                  ...
                  i = 0,
                  n = this._disabledEvents.length; i < n; i++)
          ...
          L.OpacitiesAction = L.EditAction.extend({
              initialize: function(e, i, o) {
                  var n = i.editing._mode;
                  (o = o || {}).toolbarIcon = {
                      svg: !0,
                      html: "opacities",
                      tooltip: "Set custom opacity",
                      className: "lock" === n ? "disabled" : ""
                  },
                  o.subToolbar = new L.OpacitiesToolbar2({
                      actions: t
                  }),
                  L.DistortableImage.action_map.o = "lock" === n ? "" : "_setOpacities",
                  L.EditAction.prototype.initialize.call(this, e, i, o)
              },
              addHooks: function() {
                  var t = this
                    , e = this._link;
                  L.DomUtil.hasClass(e, "subtoolbar_enabled") ? (L.DomUtil.removeClass(e, "subtoolbar_enabled"),
                  setTimeout((function() {
                      t.options.subToolbar._hide()
                  }
                  ), 100)) : L.DomUtil.addClass(e, "subtoolbar_enabled"),
                  L.IconUtil.toggleXlink(e, "opacities", "cancel"),
                  L.IconUtil.toggleTitle(e, "Make Image Transparent", "Cancel")
              }
          })
      },
      944: function() {
          L.OpacityAction = L.EditAction.extend({
              initialize: function(t, e, i) {
                  ...
                  L.DistortableImage.action_map.o = "lock" === r ? "" : "_toggleOpacity",
                  L.EditAction.prototype.initialize.call(this, t, e, i)
              },
              addHooks: function() {
                  var t = this._overlay.editing
      ...
      743: function() {
          L.EXIF = function(t) {
              if (0 !== Object.keys(EXIF.getAllTags(t)).length) {
                  ...
                  void 0 !== e.GPSLatitude && void 0 !== e.GPSLongitude && (e.GPSLatitude[0],
                  e.GPSLatitude[1],
                  e.GPSLatitude[2],
                  e.GPSLongitude[0],
                  e.GPSLongitude[1],
                  ...
                  e.GPSLatitudeRef,
                  e.GPSLongitudeRef),
                  "T" === e.GPSImgDirectionRef || "M" === e.GPSImgDirectionRef ? (Math.PI,
                  e.GPSImgDirection.numerator,
                  e.GPSImgDirection.denominator) : console.log("No compass data found"),
                  console.log("Orientation:", e.Orientation),
                  (6 === e.Orientation || 8 === e.Orientation || 3 === e.Orientation) && Math.PI,
                  void 0 !== e.GPSAltitude && void 0 !== e.GPSAltitudeRef && void 0 !== e.GPSAltitude && void 0 !== e.GPSAltitudeRef && (e.GPSAltitude.numerator,
          ...
          L.EditHandle = L.Marker.extend({
              ...
              calculateAngleDelta: function(t, e) {
                  var i = this._handled
                    ...
                    , a = o.latLngToLayerPoint(t)
                    , r = o.latLngToLayerPoint(e)
                    , s = Math.atan2(n.y - a.y, n.x - a.x);
                  return Math.atan2(n.y - r.y, n.x - r.x) - s
              }
          })
      },
      206: function() {
          L.FreeRotateHandle = L.EditHandle.extend({
              ...
              _onHandleDrag: function() {
                  ...
                  var r = t.edgeMinWidth;
                  r || (r = 50);
                  var s = e.latLngToContainerPoint(t.getCorner(0))
                    , l = e.latLngToContainerPoint(t.getCorner(1))
                    , c = Math.abs(s.x - l.x)
                    , d = Math.abs(s.y - l.y);
                  Math.sqrt(c * c + d * d) > r || a > 1 ? t.scaleBy(a) : t.scaleBy(1)
              },
              updateHandle: function() {
                  this.setLatLng(this._handled.getCorner(this._corner))
              }
      ...
      350: function() {
          L.ScaleHandle = L.EditHandle.extend({
              ...
              _onHandleDrag: function() {
                  ...
                  i || (i = 50);
                  var r = e.latLngToLayerPoint(t.getCorner(0))
      ...
      999: function() {
          L.DomUtil = L.extend(L.DomUtil, {
              ...
              confirmDeletes: function(t) {
                  ...
                  var e, i = this.translation.confirmImagesDeletes;
                  return e = "function" == typeof i ? i(t) : i,
                  window.confirm(e)
              }
          })
      },
      ...
      360: function() {
          L.MatrixUtil = {
              ...
              basisToPoints: function(t, e, i, o, n, a, r, s) {
                  var l = [t, i, n, e, o, a, 1, 1, 1]
                    , c = L.MatrixUtil.multmv(L.MatrixUtil.adj(l), [r, s, 1]);
              ...
              general2DProjection: function(t, e, i, o, n, a, r, s, l, c, d, h, u, m, g, p) {
                  var f = L.MatrixUtil.basisToPoints(t, e, n, a, l, c, u, m)
                    , v = L.MatrixUtil.basisToPoints(i, o, r, s, d, h, g, p)
                    , _ = L.MatrixUtil.multmm(v, L.MatrixUtil.adj(f));
                  return L.MatrixUtil.multsm(1 / _[8], _)
              }
          }
      },
      682: function() {
