...
class Tiles:
    ...
    def _tile_xy(self, x, y) -> Generator[_Tile, None, None]:
        """
        Generate _Tile objects for the instance's rasterio dataset and zooms.
        ...
        for zoom in self.zooms:
            zoom_properties = self._build_zoom(zoom)
            tile = self._build_tile(zoom, x, y, zoom_properties.tile_dims)
            return tile
    ...
    def write(self, directory, driver: str = "PNG") -> None:
        """
