(function (factory) {
    ...
    /** @lends L.Edit.Rectangle.prototype */
    {
      ...
      _resize: function (latlng) {
        ...
        this._shape._map.fire('draw:editresize', {
          layer: this._shape
        });
      },
      ...
      _enableRotate: function () {
        ...
        this._shape.on('rotatestart', this._onStartRotateFeature, this).on('rotateend', this._onStopRotateFeature, this);
      },
      ...
      _disableRotate: function () {
        ...
        this._shape.off('rotatestart', this._onStartRotateFeature, this).off('rotateend', this._onStopRotateFeature, this);
      },
  ...
  (function (factory) {
    ...
    L.Handler.PathTransform = L.Handler.extend({
      ...
      _onDragEnd: function (evt) {
        ...
        console.log((evt.layer ? evt.layer : this._path).dragging)
